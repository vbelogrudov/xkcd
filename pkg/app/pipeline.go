...
// Pipes of pipeline use the task struct to allow easier embedding of new pipes
// Pipe signatures are also the same, except for fanout/fanin
...
func (a *App) runSyncPipeline(ctx context.Context) error {
